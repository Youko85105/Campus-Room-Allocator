                ...
                <div class="col-md-4 text-end">
                    <div class="btn-group" role="group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="export.php?type=rooms" target="_blank">
                                <i class="fas fa-door-open"></i> Export Rooms
                            </a></li>
                            <li><a class="dropdown-item" href="export.php?type=students" target="_blank">
                                <i class="fas fa-users"></i> Export Students
                            </a></li>
                            <li><a class="dropdown-item" href="export.php?type=allocations" target="_blank">
                                <i class="fas fa-clipboard-list"></i> Export Allocations
                            </a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="export.php?type=occupancy_report" target="_blank">
